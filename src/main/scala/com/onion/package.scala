...
package object onion {
  ...
  private[onion]type Traversable[+A] = scala.collection.immutable.Traversable[A]

  private[onion]type Iterable[+A] = scala.collection.immutable.Iterable[A]

  private[onion]type Seq[+A] = scala.collection.immutable.Seq[A]

  private[onion]type IndexedSeq[+A] = scala.collection.immutable.IndexedSeq[A]
